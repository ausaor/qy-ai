...
/**
 * 问候邮件模板渲染验证
 * 确认 templates/greeting-email.html 可正常渲染，且包含项目名「青语」、发送人「聴夏」、开头敬语与问候内容
 */
@DisplayName("问候邮件模板渲染")
class GreetingEmailTemplateTest {

    @Test
    @DisplayName("模板渲染应包含项目名称、发送人名称、开头敬语与问候内容")
    void templateShouldContainProjectNameSenderAndGreeting() {
        ...
        context.setVariable("salutation", "亲爱的 春：");
        ...
        assertTrue(html.contains("亲爱的 春："), "模板应包含开头敬语");
